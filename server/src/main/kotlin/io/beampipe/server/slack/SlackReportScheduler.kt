        ...
        newSuspendedTransaction {
            ...
            SlackSubscriptions
                ...
                .forEach { subscription ->
                    ...
                    val cron = CronParser(cronDefinition).parse(subscription[SlackSubscriptions.subscriptionCron])
                    ...
                    val nextTime = ExecutionTime.forCron(cron).nextExecution(timeAfter).get()
