...
## 2020-09-19
- Major: You can now apply a time-interval based drilldown by clicking and dragging on the time chart.
![](/time-interval-drilldown.gif)
...
<img src="/drilldown2.gif" alt="Drilldown demo" style="width: 512px; "/>
