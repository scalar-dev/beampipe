...
visit your site at www.mysite.com, enter `mysite.com` into the domain box.
...
<script
  ...
  data-beampipe-domain="mysite.com"
>
</script>
```

`mysite.com` should match exactly what you entered when you created the domain.
