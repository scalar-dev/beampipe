...
First things first, you'll need to setup your domain on our site. To do this, head to the dashboard and hit the **Add** button to create a new domain. The should be "bare" without `http://` or `www.` So for instance if you normally visit your site at www.example.com, enter `example.com` into the domain box.
